...
## تحديثات أغسطس 2026
- لوحة يومية جديدة للطالب وولي الأمر مستوحاة من التصميم المرجعي، مع قرآن/أذكار/دعاء/حديث/قبلة واختبار.
- قارئ مصحف منفصل مع قائمة 114 سورة، عدد الآيات، وتصنيف مكية/مدنية، وملف المصحف المرفق.
- تحسين فحص الغش متعدد الإشارات: الوجه، أكثر من وجه، اتجاه الرأس والنظر، إغلاق العين المستمر، الصفحة المخفية، وإصبع واحد في أي مكان.
- جلسة فحص واحدة للاختبار تستمر بين الأسئلة، وتحذير ثم حجب مؤقت مع استعادة تلقائية دون فقد الإجابات.
- إعدادات موحدة مركزية مع مفتاح مستقل لكل تسميع/اختبار/مهمة، ومساعدة قرار من Gemini ثم Groq باستخدام إشارات رقمية فقط.
- إزالة التحميل الاستباقي للتطبيق الكامل من صفحة الترحيب وتحميله عند الحاجة.
- ترجمة هجينة: قاموس محلي ثم Gemini/Groq للنصوص غير الموجودة بالقاموس.
